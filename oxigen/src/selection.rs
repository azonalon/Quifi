        ...
        match self {
            Roulette => {
                ...
                for _i in 0..selection_rate {
                    ...
                    // let random = Standard::sample(&mut thread_rng());
                    let mut accum = 0_f64;
            ...
            Tournaments(n_tournaments) => {
                ...
                .for_each_with(sender, |s, _t| {
                    ...
                    for _f in 0..selection_rate {
                        ...
                        let sel = Uniform::from(0..fitnesses.len()).sample(&mut thread_rng());
            ...
            Cup => {
                ...
                }
                {
                    ...
                    while i < last_phase.len() {
                        ...
                        let sel = Uniform::from(0..candidates.len()).sample(&mut thread_rng());
                    ...
                    .map(|(_i, p)| p)
                {
                    for winner in phase.iter() {
                        if winners.is_empty() {
                            ...
                            let index = Uniform::from(0..winners.len()).sample(&mut thread_rng());
